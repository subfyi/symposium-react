...
var qname = "Kalite Kontrol Türleri";
var qtype = "paramcheck";
var qredirect = "/tur/kalitekontrolturu";
var ptur = 'check';

export class KaliteKontrolTuruEkle extends Component {
  render() {
...
export class KaliteKontrolTuruList extends Component {
  render() {
