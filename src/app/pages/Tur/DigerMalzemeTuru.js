...
var qname = "Diger Malzeme";
var qtype = "dmalgrupcon";
var qredirect = "/tur/dmalgrup";
var ptur = 'nar';



export class DigerMalzemeTuruEkle extends Component {
  render() {
...
export class DigerMalzemeTuruList extends Component {
  render() {
