...
var qname = "Kesif Yapilacak Malzeme";
var qtype = "kmaterialcon";
var qredirect = "/tur/kmalzemeturu";
var ptur = 'nar';



export class KesifYapilacakMalzemeEkle extends Component {
  render() {
...
export class KesifYapilacakMalzemeList extends Component {
  render() {
