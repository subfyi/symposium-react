...
var qname = "Üretim Bakım Onarım Türü";
var qtype = "ubmaterialcon";
var qredirect = "/tur/ubmalzemeturu";
var ptur = 'nar';

export class UretimBakimOnarimTuruEkle extends Component {
  render() {
...
export class UretimBakimOnarimTuruList extends Component {
  render() {
